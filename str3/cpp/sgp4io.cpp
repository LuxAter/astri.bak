 ...
 *                           fix input format and delete unused variables in
 * twoline2rv changes : 3 sep 08  david vallado add operationmode for afspc (a)
 * or improved (i) 9 may 07  david vallado fix year
 * correction to 57 27 mar 07  david vallado misc
 * fixes to manual inputs 14 aug 06  david vallado
 *                           original baseline
 *       ---------------------------------------------------------------- */
