#ifndef ICOSASPHERE_HPP_1KW6RLXS
#define ICOSASPHERE_HPP_1KW6RLXS
...
class IcosaSphere {
 public:
  IcosaSphere(float radius = 1.0, unsigned sub = 1);
  ...
  inline glm::mat4& at(std::size_t i) { return instances[i]; }
  inline glm::mat4& operator[](std::size_t i) { return instances[i]; }
...
#endif /* end of include guard: ICOSASPHERE_HPP_1KW6RLXS */
